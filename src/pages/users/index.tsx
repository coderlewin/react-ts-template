...
const columns: ProColumns<API.UserVO>[] = [
	...
	},
	{
		...
		hideInSearch: true,
		render: (_, record) => {
			return <Typography.Text>{new Date(record.create_time! * 1000).toLocaleString()}</Typography.Text>
		}
	},
	{
		title: '更新时间',
		...
		hideInSearch: true,
		render: (_, record) => {
			return <Typography.Text>{new Date(record.update_time! * 1000).toLocaleString()}</Typography.Text>
		}
	},
	{
		title: '操作',
